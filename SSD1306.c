...
{
  uint8_t ix=0;
  uint8_t comm[]={0xAE,0xD5,0xF0,0xA8,0x3F,0xD3,0x00,0x40,0x8D,0x14,0xA1,
    0xC8,0x20,0x00,0xDA,0x12,0xD9,0xE1,0xDB,0x40,0xA4,0xA6,0xAF,0xFF};
